...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "801",  .family = FAMILY_GAMMA_TURBO_RES, .EMC2103 = true,                                                         .temp_offset = -10, .TPS546E25 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
};
